...
- PerplexityAPI: Manages API interactions
...
```python
def generate_xyz_paragraph(data_loader, state_code: str = 'AC') -> str:
...
try:
    ...
    raise ValueError(f"Specific error context: {e}")  # Hard failure
```
...
4. Results formatted according to Brazilian standards

### Content Generation Chain
1. automacao.py initializes components
2. Each paragraph generator:
   - Gets data from DataLoader
   - Uses PerplexityAPI if needed
